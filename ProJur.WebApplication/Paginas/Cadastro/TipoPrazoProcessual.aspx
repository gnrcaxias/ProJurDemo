<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoPrazoProcessual.aspx.cs" Inherits="ProJur.WebApplication.Paginas.Cadastro.TipoPrazoProcessual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="cadastroAcoes">
        ...
        <div id="cadastroAcoesListaItens">
            <uc1:menuAcoesCadastro ID="menuAcoesCadastro" runat="server" NovoUrl="/Paginas/Manutencao/TipoPrazoProcessual.aspx" NovoTexto="Incluir tipo de prazo" />
        </div>
    </div>
    ...
    <div id="cadastroCorpo">
        ...
        <div id="cadastroCorpoResultado">
            ...
            <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" 
                ...
                <EmptyDataTemplate>
                    <center>Nenhuma tipo de prazo processual encontrado</center>
                </EmptyDataTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdIdTipoPrazoProcessual" runat="server" Value='<%# Eval("idTipoPrazoProcessual") %>' />
                        </ItemTemplate>

                    </asp:TemplateField>

                    <asp:BoundField DataField="idTipoPrazoProcessual" HeaderText="Código" 
                        SortExpression="idTipoPrazoProcessual" HeaderStyle-Width="65px" >
                    ...
                    <asp:TemplateField ShowHeader="false">
                        ...
                        <ItemTemplate>
                            <a class="botaoAcao" href='<%= ProJur.DataAccess.Configuracao.getEnderecoVirtualSite() %><%# Eval("idTipoPrazoProcessual", "/Paginas/Manutencao/TipoPrazoProcessual.aspx?ID={0} ") %>' title="Visualizar os dados" >
            ...
            <asp:ObjectDataSource ID="dsResultado" runat="server" 
                ...
                TypeName="ProJur.Business.Bll.bllTipoPrazoProcessual" 
