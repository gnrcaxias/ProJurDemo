<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FaseProcessual.aspx.cs" Inherits="ProJur.WebApplication.Paginas.Cadastro.FaseProcessual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="cadastroAcoes">
        ...
        <div id="cadastroAcoesListaItens">
            <uc1:menuAcoesCadastro ID="menuAcoesCadastro" runat="server" NovoUrl="/Paginas/Manutencao/FaseProcessual.aspx" NovoTexto="Incluir fase" />
        </div>
    </div>
    ...
    <div id="cadastroCorpo">
        ...
        <div id="cadastroCorpoResultado">
            ...
            <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" 
                ...
                <EmptyDataTemplate>
                    <center>Nenhuma fase processual encontrada</center>
                </EmptyDataTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdIdFaseProcessual" runat="server" Value='<%# Eval("idFaseProcessual") %>' />
                        </ItemTemplate>

                    </asp:TemplateField>

                    <asp:BoundField DataField="idFaseProcessual" HeaderText="Código" 
                        SortExpression="idFaseProcessual" HeaderStyle-Width="65px" >
                    ...
                    <asp:TemplateField ShowHeader="false">
                        ...
                        <ItemTemplate>
                            <a class="botaoAcao" href='<%= ProJur.DataAccess.Configuracao.getEnderecoVirtualSite() %><%# Eval("idFaseProcessual", "/Paginas/Manutencao/FaseProcessual.aspx?ID={0} ") %>' title="Visualizar os dados" >
            ...
            <asp:ObjectDataSource ID="dsResultado" runat="server" 
                ...
                TypeName="ProJur.Business.Bll.bllFaseProcessual" 
