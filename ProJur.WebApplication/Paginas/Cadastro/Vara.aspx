<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vara.aspx.cs" Inherits="ProJur.WebApplication.Paginas.Cadastro.Vara" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="cadastroAcoes">
        ...
        <div id="cadastroAcoesListaItens">
            <uc1:menuAcoesCadastro ID="menuAcoesCadastro" runat="server" NovoUrl="/Paginas/Manutencao/Vara.aspx" NovoTexto="Incluir vara" />
        </div>
    </div>
    ...
    <div id="cadastroCorpo">
        ...
        <div id="cadastroCorpoResultado">
            ...
            <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" 
                ...
                <EmptyDataTemplate>
                    <center>Nenhuma vara encontrada</center>
                </EmptyDataTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdIdVara" runat="server" Value='<%# Eval("idVara") %>' />
                        </ItemTemplate>

                    </asp:TemplateField>

                    <asp:BoundField DataField="idVara" HeaderText="Código" 
                        SortExpression="idVara" HeaderStyle-Width="65px" >
                    ...
                    <asp:TemplateField ShowHeader="false">
                        ...
                        <ItemTemplate>
                            <a class="botaoAcao" href='<%= ProJur.DataAccess.Configuracao.getEnderecoVirtualSite() %><%# Eval("idVara", "/Paginas/Manutencao/Vara.aspx?ID={0} ") %>' title="Visualizar os dados" >
            ...
            <asp:ObjectDataSource ID="dsResultado" runat="server" 
                ...
                TypeName="ProJur.Business.Bll.bllVara" 
