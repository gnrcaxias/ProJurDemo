<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Comarca.aspx.cs" Inherits="ProJur.WebApplication.Paginas.Cadastro.Comarca" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="cadastroAcoes">
        ...
        <div id="cadastroAcoesListaItens">
            <uc1:menuAcoesCadastro ID="menuAcoesCadastro" runat="server" NovoUrl="/Paginas/Manutencao/Comarca.aspx" NovoTexto="Incluir comarca" />
        </div>
    </div>
    ...
    <div id="cadastroCorpo">
        ...
        <div id="cadastroCorpoResultado">
            ...
            <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" 
                ...
                <EmptyDataTemplate>
                    <center>Nenhuma comarca encontrada</center>
                </EmptyDataTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdIdComarca" runat="server" Value='<%# Eval("idComarca") %>' />
                        </ItemTemplate>

                    </asp:TemplateField>

                    <asp:BoundField DataField="idComarca" HeaderText="Código" 
                        SortExpression="idComarca" HeaderStyle-Width="65px" >
                    ...
                    <asp:TemplateField ShowHeader="false">
                        ...
                        <ItemTemplate>
                            <a class="botaoAcao" href='<%= ProJur.DataAccess.Configuracao.getEnderecoVirtualSite() %><%# Eval("idComarca", "/Paginas/Manutencao/Comarca.aspx?ID={0} ") %>' title="Visualizar os dados" >
            ...
            <asp:ObjectDataSource ID="dsResultado" runat="server" 
                ...
                TypeName="ProJur.Business.Bll.bllComarca" 
