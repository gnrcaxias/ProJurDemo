<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategoriaPeca.aspx.cs" Inherits="ProJur.WebApplication.Paginas.Cadastro.CategoriaPeca" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="cadastroAcoes">
        ...
        <div id="cadastroAcoesListaItens">
            <uc1:menuAcoesCadastro ID="menuAcoesCadastro" runat="server" NovoUrl="/Paginas/Manutencao/CategoriaPeca.aspx" NovoTexto="Incluir categoria" />
        </div>
    </div>
    ...
    <div id="cadastroCorpo">
        ...
        <div id="cadastroCorpoResultado">
            ...
            <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" 
                ...
                <EmptyDataTemplate>
                    <center>Nenhuma categoria de peça processual encontrada</center>
                </EmptyDataTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdIdCategoriaPeca" runat="server" Value='<%# Eval("idCategoriaPeca") %>' />
                        </ItemTemplate>

                    </asp:TemplateField>

                    <asp:BoundField DataField="idCategoriaPeca" HeaderText="Código" 
                        SortExpression="idCategoriaPeca" HeaderStyle-Width="65px" >
                    ...
                    <asp:TemplateField ShowHeader="false">
                        ...
                        <ItemTemplate>
                            <a class="botaoAcao" href='<%= ProJur.DataAccess.Configuracao.getEnderecoVirtualSite() %><%# Eval("idCategoriaPeca", "/Paginas/Manutencao/CategoriaPeca.aspx?ID={0} ") %>' title="Visualizar os dados" >
            ...
            <asp:ObjectDataSource ID="dsResultado" runat="server" 
                ...
                TypeName="ProJur.Business.Bll.bllCategoriaPeca" 
