<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoPrazoProcessual.aspx.cs" Inherits="ProJur.WebApplication.Paginas.Manutencao.TipoPrazoProcessual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ProJur:menuAcoesManutencao ID="menuAcoes" runat="server" NovoUrl="/Paginas/Manutencao/TipoPrazoProcessual.aspx"
        PesquisarUrl="/Paginas/Cadastro/TipoPrazoProcessual.aspx" />
    ...
    <div id="manutencaoCorpoSecao">
        <asp:DetailsView ID="dvManutencao" runat="server" Width="100%" AutoGenerateRows="False"
            CellPadding="10" GridLines="None" DataSourceID="dsManutencao" DataKeyNames="idTipoPrazoProcessual" class="DetailsView">
            ...
            <Fields>
                ...
                <asp:BoundField DataField="idTipoPrazoProcessual" HeaderText="Código" InsertVisible="false"
                    ReadOnly="true" />
        ...
        <asp:ObjectDataSource ID="dsManutencao" runat="server" DataObjectTypeName="ProJur.Business.Dto.dtoTipoPrazoProcessual"
            OldValuesParameterFormatString="original_{0}" SelectMethod="Get" TypeName="ProJur.Business.Bll.bllTipoPrazoProcessual"
            UpdateMethod="Update" InsertMethod="Insert" OnInserted="dsManutencao_Inserted"
            DeleteMethod="Delete">

            <SelectParameters>
                <asp:QueryStringParameter Name="idTipoPrazoProcessual" QueryStringField="ID" Type="Int32" />
            </SelectParameters>
