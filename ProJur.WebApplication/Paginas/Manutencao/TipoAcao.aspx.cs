    ...
    public partial class TipoAcao : System.Web.UI.Page
    {
        ...
        protected void Cancelar_Click(object sender, EventArgs e)
        {
                ...
                && Request.QueryString["ID"].Trim() != String.Empty)
            {
                ...
                Response.Redirect(String.Format("{0}/Paginas/Cadastro/TipoAcao.aspx", ProJur.DataAccess.Configuracao.getEnderecoVirtualSite()));
        }
        ...
        {
            Response.Redirect(String.Format("{0}/Paginas/Manutencao/TipoAcao.aspx?ID={1}", ProJur.DataAccess.Configuracao.getEnderecoVirtualSite(), e.ReturnValue));
        }
