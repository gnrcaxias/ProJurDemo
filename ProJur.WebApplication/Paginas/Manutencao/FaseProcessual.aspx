<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FaseProcessual.aspx.cs" Inherits="ProJur.WebApplication.Paginas.Manutencao.FaseProcessual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ProJur:menuAcoesManutencao ID="menuAcoes" runat="server" NovoUrl="/Paginas/Manutencao/FaseProcessual.aspx"
        PesquisarUrl="/Paginas/Cadastro/FaseProcessual.aspx" />
    ...
    <div id="manutencaoCorpoSecao">
        <asp:DetailsView ID="dvManutencao" runat="server" Width="100%" AutoGenerateRows="False"
            CellPadding="10" GridLines="None" DataSourceID="dsManutencao" DataKeyNames="idFaseProcessual" class="DetailsView">
            ...
            <Fields>
                ...
                <asp:BoundField DataField="idFaseProcessual" HeaderText="Código" InsertVisible="false"
                    ReadOnly="true" />
        ...
        <asp:ObjectDataSource ID="dsManutencao" runat="server" DataObjectTypeName="ProJur.Business.Dto.dtoFaseProcessual"
            OldValuesParameterFormatString="original_{0}" SelectMethod="Get" TypeName="ProJur.Business.Bll.bllFaseProcessual"
            UpdateMethod="Update" InsertMethod="Insert" OnInserted="dsManutencao_Inserted"
            DeleteMethod="Delete">

            <SelectParameters>
                <asp:QueryStringParameter Name="idFaseProcessual" QueryStringField="ID" Type="Int32" />
            </SelectParameters>
