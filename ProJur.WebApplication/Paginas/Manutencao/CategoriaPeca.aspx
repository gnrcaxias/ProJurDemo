<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategoriaPeca.aspx.cs" Inherits="ProJur.WebApplication.Paginas.Manutencao.CategoriaPeca" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ProJur:menuAcoesManutencao ID="menuAcoes" runat="server" NovoUrl="/Paginas/Manutencao/CategoriaPeca.aspx"
        PesquisarUrl="/Paginas/Cadastro/CategoriaPeca.aspx" />
    ...
    <div id="manutencaoCorpoSecao">
        <asp:DetailsView ID="dvManutencao" runat="server" Width="100%" AutoGenerateRows="False"
            CellPadding="10" GridLines="None" DataSourceID="dsManutencao" DataKeyNames="idCategoriaPeca" class="DetailsView">
            ...
            <Fields>
                ...
                <asp:BoundField DataField="idCategoriaPeca" HeaderText="Código" InsertVisible="false"
                    ReadOnly="true" />
        ...
        <asp:ObjectDataSource ID="dsManutencao" runat="server" DataObjectTypeName="ProJur.Business.Dto.dtoCategoriaPeca"
            OldValuesParameterFormatString="original_{0}" SelectMethod="Get" TypeName="ProJur.Business.Bll.bllCategoriaPeca"
            UpdateMethod="Update" InsertMethod="Insert" OnInserted="dsManutencao_Inserted"
            DeleteMethod="Delete">

            <SelectParameters>
                <asp:QueryStringParameter Name="idCategoriaPeca" QueryStringField="ID" Type="Int32" />
            </SelectParameters>
