...
{
    public partial class FaseProcessual : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Master.litCaminhoSecundario.Text = "Fase Processual";
        }
        ...
        protected void Cancelar_Click(object sender, EventArgs e)
        {
                ...
                && Request.QueryString["ID"].Trim() != String.Empty)
            {
                ...
                Response.Redirect(String.Format("{0}/Paginas/Cadastro/FaseProcessual.aspx", ProJur.DataAccess.Configuracao.getEnderecoVirtualSite()));
        }
        ...
        {
            Response.Redirect(String.Format("{0}/Paginas/Manutencao/FaseProcessual.aspx?ID={1}", ProJur.DataAccess.Configuracao.getEnderecoVirtualSite(), e.ReturnValue));
        }
