<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SituacaoProcesso.aspx.cs" Inherits="ProJur.WebApplication.Paginas.Manutencao.SituacaoProcesso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ProJur:menuAcoesManutencao ID="menuAcoes" runat="server" NovoUrl="/Paginas/Manutencao/SituacaoProcesso.aspx"
        PesquisarUrl="/Paginas/Cadastro/SituacaoProcesso.aspx" />
    ...
    <div id="manutencaoCorpoSecao">
        <asp:DetailsView ID="dvManutencao" runat="server" Width="100%" AutoGenerateRows="False"
            CellPadding="10" GridLines="None" DataSourceID="dsManutencao" DataKeyNames="idSituacaoProcesso" class="DetailsView">
            ...
            <Fields>
                ...
                <asp:BoundField DataField="idSituacaoProcesso" HeaderText="Código" InsertVisible="false"
                    ReadOnly="true" />
        ...
        <asp:ObjectDataSource ID="dsManutencao" runat="server" DataObjectTypeName="ProJur.Business.Dto.dtoSituacaoProcesso"
            OldValuesParameterFormatString="original_{0}" SelectMethod="Get" TypeName="ProJur.Business.Bll.bllSituacaoProcesso"
            UpdateMethod="Update" InsertMethod="Insert" OnInserted="dsManutencao_Inserted"
            DeleteMethod="Delete">

            <SelectParameters>
                <asp:QueryStringParameter Name="idSituacaoProcesso" QueryStringField="ID" Type="Int32" />
            </SelectParameters>
