<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Estado.aspx.cs" Inherits="ProJur.WebApplication.Paginas.Manutencao.Estado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ProJur:menuAcoesManutencao ID="menuAcoes" runat="server" NovoUrl="/Paginas/Manutencao/Estado.aspx"
        PesquisarUrl="/Paginas/Cadastro/Estado.aspx" />
    ...
    <div id="manutencaoCorpoSecao">
        <asp:DetailsView ID="dvManutencao" runat="server" Width="100%" AutoGenerateRows="False"
            CellPadding="10" GridLines="None" DataSourceID="dsManutencao" DataKeyNames="idEstado" class="DetailsView">
            ...
            <Fields>
                ...
                <InfoVillage:BoundTextBoxField DataField="siglaUF" HeaderText="Sigla UF" ControlStyle-Width="300px"
                    Required="true" MaxLength="2" />

            </Fields>
        </asp:DetailsView>

        <asp:ObjectDataSource ID="dsManutencao" runat="server" DataObjectTypeName="ProJur.Business.Dto.dtoEstado"
            OldValuesParameterFormatString="original_{0}" SelectMethod="Get" TypeName="ProJur.Business.Bll.bllEstado"
            UpdateMethod="Update" InsertMethod="Insert" OnInserted="dsManutencao_Inserted"
            DeleteMethod="Delete">

            <SelectParameters>
                <asp:QueryStringParameter Name="idEstado" QueryStringField="ID" Type="Int32" />
            </SelectParameters>
