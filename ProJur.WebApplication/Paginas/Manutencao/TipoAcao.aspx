<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoAcao.aspx.cs" Inherits="ProJur.WebApplication.Paginas.Manutencao.TipoAcao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ProJur:menuAcoesManutencao ID="menuAcoes" runat="server" NovoUrl="/Paginas/Manutencao/TipoAcao.aspx"
        PesquisarUrl="/Paginas/Cadastro/TipoAcao.aspx" />
    ...
    <div id="manutencaoCorpoSecao">
        <asp:DetailsView ID="dvManutencao" runat="server" Width="100%" AutoGenerateRows="False"
            CellPadding="10" GridLines="None" DataSourceID="dsManutencao" DataKeyNames="idTipoAcao" class="DetailsView">
            ...
            <Fields>
                ...
                <asp:BoundField DataField="idTipoAcao" HeaderText="Código" InsertVisible="false"
                    ReadOnly="true" />
        ...
        <asp:ObjectDataSource ID="dsManutencao" runat="server" DataObjectTypeName="ProJur.Business.Dto.dtoTipoAcao"
            OldValuesParameterFormatString="original_{0}" SelectMethod="Get" TypeName="ProJur.Business.Bll.bllTipoAcao"
            UpdateMethod="Update" InsertMethod="Insert" OnInserted="dsManutencao_Inserted"
            DeleteMethod="Delete">

            <SelectParameters>
                <asp:QueryStringParameter Name="idTipoAcao" QueryStringField="ID" Type="Int32" />
            </SelectParameters>
