<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vara.aspx.cs" Inherits="ProJur.WebApplication.Paginas.Manutencao.Vara" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ProJur:menuAcoesManutencao ID="menuAcoes" runat="server" NovoUrl="/Paginas/Manutencao/Vara.aspx"
        PesquisarUrl="/Paginas/Cadastro/Vara.aspx" />
    ...
    <div id="manutencaoCorpoSecao">
        <asp:DetailsView ID="dvManutencao" runat="server" Width="100%" AutoGenerateRows="False"
            CellPadding="10" GridLines="None" DataSourceID="dsManutencao" DataKeyNames="idVara" class="DetailsView">
            ...
            <Fields>
                ...
                <asp:BoundField DataField="idVara" HeaderText="Código" InsertVisible="false"
                    ReadOnly="true" />
        ...
        <asp:ObjectDataSource ID="dsManutencao" runat="server" DataObjectTypeName="ProJur.Business.Dto.dtoVara"
            OldValuesParameterFormatString="original_{0}" SelectMethod="Get" TypeName="ProJur.Business.Bll.bllVara"
            UpdateMethod="Update" InsertMethod="Insert" OnInserted="dsManutencao_Inserted"
            DeleteMethod="Delete">

            <SelectParameters>
                <asp:QueryStringParameter Name="idVara" QueryStringField="ID" Type="Int32" />
            </SelectParameters>
